export const LoginPageLocators = {  
    ...
    newsUserFirstNameInput: 'input[data-qa="first_name"]',
...
export const HomePageLocators = {  
    // Навбар / верхнее меню 
     ...
     // Бренды (слева)  
     brandsSection: '.brands_products',  brandItem: '.brands-name a',  
     
     // Подвал  
     footer: 'footer',  footerText: 'footer .footer-bottom',
    };
    ...
    export const ProductsPageLocators = { 
        ...
        searchButton: '#submit_search',  // Заголовок страницы  
        productsTitle: '.features_items > h2',  // Карточки товаров  
        productCard: '.product-image-wrapper',  
        productName: '.productinfo p',  // Кнопка "View Product"  
        viewProductLinks: '.product-overlay a',  // Результаты поиска  
        searchedProductsTitle: '.features_items h2',  
        searchedProductCard: '.features_items .product-image-wrapper',  // Категории (слева)  
        categorySection: '.left-sidebar .panel-group',  
        categoryItem: '.category-products .panel-title a',  // Бренды (слева)  
        brandsSection: '.brands_products',  
        brandItem: '.brands-name a',  // Сообщение "Searched Products"  
        searchedProductsHeader: 'h2.title.text-center',  // "Add to cart" кнопка (внутри overlay)  
...
export const ContactUsPageLocators = {  // Заголовок страницы  
    contactUsTitle: '.contact-form h2.title.text-center',  // Поля формы  
    nameInput: '[data-qa="name"]',  
    emailInput: '[data-qa="email"]',  
    subjectInput: '[data-qa="subject"]',  
    messageTextarea: '[data-qa="message"]',  // Кнопка загрузки файла  
    uploadFileInput: 'input[name="upload_file"]',  // Кнопка "Submit"  
    submitButton: '[data-qa="submit-button"]',  // Alert с успешным сообщением  
    successAlert: '.status.alert.alert-success',  // Кнопка "Home"  
    homeButton: '.btn.btn-success',  // Ошибка, если поля не заполнены (если применимо)  
